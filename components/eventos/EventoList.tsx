          ...
          >
            ...
            {currentUser.role === 'COORDENADOR' && (
              <div className="px-4 pb-4 flex gap-2">
                <button
                  onClick={() => onSelect(evento)}
                  className="flex-1 text-[10px] font-black uppercase tracking-widest bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 py-2 rounded-xl active:scale-95 transition-transform"
                >
